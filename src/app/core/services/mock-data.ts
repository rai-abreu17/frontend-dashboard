...
export const MOCK_BOXES: Box[] = [
  ...
  { id: 'b3', code: 'BOX-03', name: 'Box 03', operationalStatus: 'RECEBENDO', measurementStatus: 'VALIDA', currentMaterialId: 'm3', lastMaterialId: 'm3', latestValidMeasurementId: 'ms3', latestAttemptId: 'at3', instrumented: true, maxVolumeCapacityM3: 5000, ...GRANDE },
